...
def test_select_source_language_and_enter_text():
    driver.get("https://bkrsannapureddy.in/project1/index.html")  # Replace with the actual file path
    ...
    # Test Case 7:Click the audio icon below selected language
    from_audio_icon.click()
    time.sleep(5) 
    # Test Case 8:Click the audio icon below target language
    to_audio_icon.click()

    # Wait for the Chrome permissions dialog to appear
    time.sleep(5)  # Wait for 5 seconds (adjust as needed)

    # Test Case 9:Click the copy icons
